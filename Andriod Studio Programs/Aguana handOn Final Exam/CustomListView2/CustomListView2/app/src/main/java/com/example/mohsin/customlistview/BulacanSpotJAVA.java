...
public class BulacanSpotJAVA extends AppCompatActivity {
    int Check;
    int SpotDays;
    int SpotGuests;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bulacan_spot);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.apply();
                startActivity(new Intent(BulacanSpotJAVA.this,BulacanSpotPayment.class));
            }
        });
