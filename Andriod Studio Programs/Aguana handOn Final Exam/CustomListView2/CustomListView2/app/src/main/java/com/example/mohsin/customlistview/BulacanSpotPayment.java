...
public class BulacanSpotPayment extends AppCompatActivity {
    float total;
    float convDays;
    float convGuests;
    float totalCost;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bulacan_spot_payment);
        ...
        if (Check == 1) {
            ...
            image.setImageResource(R.drawable.verdivia);
            Toast.makeText(BulacanSpotPayment.this,"VERDIVIA FALLS", Toast.LENGTH_LONG).show( );
        }
        if (Check == 2) {
            ...
            ResultNumGuests.setText("total number of guests: " + NO.format(convGuests));
            Result.setText("Total payment: " + currency.format(totalCost));
            image.setImageResource(R.drawable.hike);
            Toast.makeText(BulacanSpotPayment.this,"HIKE MT. GOLA", Toast.LENGTH_LONG).show( );
        }
        if (Check == 3) {
            ...
            ResultNumGuests.setText("total number of guests: " + NO.format(convGuests));
            Result.setText("Total payment: " + currency.format(totalCost));
            image.setImageResource(R.drawable.manalmon);
            Toast.makeText(BulacanSpotPayment.this,"HIKE MT MANALMON", Toast.LENGTH_LONG).show( );
        }
