...
public class CaviteHotelJAVA extends AppCompatActivity {
    int Check;
    int IntHotelCaviteDays;
    int IntHotelCaviteRoom;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cavite_hotel);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                IntHotelCaviteDays = Integer.parseInt(days.getText().toString());
                IntHotelCaviteRoom = Integer.parseInt(room.getText().toString());
                ...
                editor.putInt("key5", IntHotelCaviteDays);
                editor.putFloat("key6", IntHotelCaviteRoom);
                editor.apply();
                startActivity(new Intent(CaviteHotelJAVA.this, CaviteHotelPayment.class));
