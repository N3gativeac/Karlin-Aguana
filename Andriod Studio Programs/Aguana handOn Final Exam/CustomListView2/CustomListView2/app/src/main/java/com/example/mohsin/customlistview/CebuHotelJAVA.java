...
public class CebuHotelJAVA extends AppCompatActivity {
    int Check;
    int IntHotelCebuDays;
    int IntHotelCebuRoom;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cebu_hotel);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                IntHotelCebuDays = Integer.parseInt(days.getText().toString());
                IntHotelCebuRoom = Integer.parseInt(room.getText().toString());
                ...
                editor.putInt("key5", IntHotelCebuDays);
                editor.putFloat("key6", IntHotelCebuRoom);
                editor.apply();
                startActivity(new Intent(CebuHotelJAVA.this, CebuHotelPayment.class));
