...
class WP_Ivecountdown {
	var $plugin_name = 'Ibtana Visual Editor';
	var $version = '1.0.5';
	var $domain = 'ive';
	var $plguin_options_page_title = 'Ive Options';
	var $plugin_options_menue_title = 'Ive Ibtana';
	...
	function iveevents_callback() {
		...
		esc_attr( WP_IveibtanaEvents::iveEvents( $_POST['event_id'] ));
		wp_die();
	}
