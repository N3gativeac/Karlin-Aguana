...
class ive_Form_Block {
    ...
    public function get_post_data() {
        ...
        if ( ! is_admin() && isset( $_POST['ive_form_id'] ) ) {
            $_SESSION['ive_form_submit_post'] = $_POST;
    ...
    public function maybe_submit_form( $block_content, $block ) {
        ...
        if ( ! empty( $errors ) ) {
            ob_start();
            ?>
            <div class="ive-alert ive-alert-form ive-alert-form-error"><div class="ive-alert-content">
                <?php
    ...
    public function assets_store( $name ) {
        if ( 'ive-block-form' === $name ) {
            ive_Assets::store_used_assets( 'ive-block-alert', true, 'style' );
            ive_Assets::store_used_assets( 'ive-block-alert', true, 'script' );
            ive_Assets::store_used_assets( 'ive-block-button', true, 'style' );
            ive_Assets::store_used_assets( 'ive-block-button', true, 'script' );
        }
    }
