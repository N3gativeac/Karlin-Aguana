...
/**
 * Class ive_Form_Field_Phone_Block
 */
class ive_Form_Field_Phone_Block {
    /**
     * ive_Form_Field_Phone_Block constructor.
     */
    ...
    public function block_render( $attributes ) {
        ...
        $class = 'ive-form-field ive-form-field-phone';

        if ( isset( $attributes['className'] ) ) {
            $class .= ' ' . $attributes['className'];
        }
        $class .= ' form_phone'.$uniqueID;
        ...
        <div class="<?php echo esc_attr( $class ); ?>">
            ...
            <input type="tel" <?php ive_Form_Field_Attributes::get( $attributes ); ?> />
...
new ive_Form_Field_Phone_Block();
