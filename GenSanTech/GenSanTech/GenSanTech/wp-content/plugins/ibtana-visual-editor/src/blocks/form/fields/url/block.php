...
/**
 * Class ive_Form_Field_Url_Block
 */
class ive_Form_Field_Url_Block {
    /**
     * ive_Form_Field_Url_Block constructor.
     */
    ...
    public function block_render( $attributes ) {
        ...
        $class = 'ive-form-field ive-form-field-url';

        if ( isset( $attributes['className'] ) ) {
            $class .= ' ' . $attributes['className'];
        }
        $class .= ' form_url'.$uniqueID;
        ...
        <div class="<?php echo esc_attr( $class ); ?>">
            ...
            <input type="url" <?php ive_Form_Field_Attributes::get( $attributes ); ?> />
