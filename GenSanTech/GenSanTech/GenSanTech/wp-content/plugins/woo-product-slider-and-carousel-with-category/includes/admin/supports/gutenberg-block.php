...
function wcpscwc_register_guten_block() {
	...
	wp_register_script( 'wcpscwc-block-js', WCPSCWC_URL.'assets/js/blocks.build.js', array( 'wp-blocks', 'wp-i18n', 'wp-element', 'wp-editor', 'wp-components' ), WCPSCWC_VERSION, true );
...
add_filter( 'block_categories', 'wcpscwc_add_block_category' );