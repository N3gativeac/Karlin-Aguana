 ...
 * @access public
 */
class diet_shop_Customize_Section_Upsell extends WP_Customize_Section {
...
class diet_shop_Demo_Content_Import extends WP_Customize_Control {
	/**
	* The type of customize section being rendered.
	*
	* @since  1.0.0
	...
	public function render_content() {
	  ...
	  ?>
        ...
        <a class="demo-now button-secondary button change-theme" href="<?php echo esc_url_raw( self_admin_url( 'themes.php?page=pt-one-click-demo-import' ) ); ?>">
            <?php esc_html_e( 'See Library', 'diet-shop' ); ?>
        </a>
        </div>
        <?php
		else:
		?>
         <p><?php echo esc_html__('To take full advantage of all the features this theme has to offer number of plugins, please install and activate all plugins.', 'diet-shop');?></p>
