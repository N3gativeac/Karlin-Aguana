...
$add['link_text_color'] = array(
	array(
		'type'     => 'css',
		'element'  => '.woocommerce .woocommerce-error .button, .woocommerce .woocommerce-info .button, .woocommerce .woocommerce-message .button, .woocommerce nav.woocommerce-pagination ul li a:hover, .woocommerce nav.woocommerce-pagination ul li a:focus, .woocommerce div.product .woocommerce-tabs ul.tabs li a:hover, .woocommerce div.product .woocommerce-tabs ul.tabs li a:focus, .woocommerce .woocommerce-breadcrumb a:hover, .woocommerce .woocommerce-breadcrumb a:focus, .woocommerce-account .onestore-woocommerce-MyAccount-sidebar a:hover, .woocommerce-account .onestore-woocommerce-MyAccount-sidebar a:focus, .woocommerce ul.products li.product a.woocommerce-loop-product__link:hover, .woocommerce ul.products li.product a.woocommerce-loop-product__link:focus, .woocommerce.widget_layered_nav_filters li a:hover, .woocommerce.widget_layered_nav_filters li a:focus',
		'property' => 'color',
	),
	array(
		'type'     => 'css',
...
$add['footer_widgets_bar_link_text_color'] = array(
	array(
		'type'     => 'css',
		'element'  => '.onestore-footer-widgets-bar .woocommerce.widget_price_filter .price_slider',
		'property' => 'color',
	),
);
 ...
 */
 ...
 $tablet = OneStore::instance()->get_screen_size( 'tablet' );
$add['woocommerce_single_gallery_width'] = array(
	array(
		'type'     => 'css',
		'element'  => '.woocommerce #content div.product div.product-media, .woocommerce div.product div.product-media',
		'property' => 'flex-basis',
		'media'    => '@media screen and (min-width: ' . $tablet . 'px)',
	),
	array(
		'type'     => 'css',
		'element'  => '.woocommerce #content div.product div.product-media ~ div.summary, .woocommerce div.product div.product-media ~ div.summary',
		'property' => 'flex-basis',
		'pattern'  => 'calc(100% - $)',
		'media'    => '@media screen and (min-width: ' . $tablet . 'px)',
	),
...
$add['woocommerce_cart_width'] = array(
	array(
		'type'     => 'css',
		'element'  => '.woocommerce-cart .wrapper, .woocommerce-cart .section-contained>.section-inner ',
		'property' => 'max-width',
	),
);
...
$add['woocommerce_checkout_width'] = array(
	array(
		'type'     => 'css',
		'element'  => '.woocommerce-checkout .wrapper, .woocommerce-checkout .section-contained>.section-inner ',
		'property' => 'max-width',
	),
);

$add['woocommerce_index_thumb_height'] = array(
	array(
		'type'     => 'css',
