...
$wp_customize->add_control( new OneStore_Customize_Control_Typography( $wp_customize, 'body_typography', array(
	'settings'    => $settings,
	'section'     => $section,
	'label'       => esc_html__( 'Body (base) text typography', 'onestore' ),
	'responsive'  => true,
	'priority'    => 10,
) ) );
...
// ------
$wp_customize->add_control( new OneStore_Customize_Control_HR( $wp_customize, 'hr_base_colors', array(
	'section'     => $section,
	'settings'    => array(),
	'priority'    => 10,
) ) );
...
// Colors
$colors = array(
	'body_text_color'       => esc_html__( 'Text color', 'onestore' ),
);
