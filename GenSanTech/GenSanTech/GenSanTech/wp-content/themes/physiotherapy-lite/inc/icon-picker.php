...
class Physiotherapy_Lite_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'physiotherapy-lite' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $physiotherapy_lite_font_awesome_icon_array = physiotherapy_lite_font_awesome_icon_array();
                    foreach ($physiotherapy_lite_font_awesome_icon_array as $physiotherapy_lite_font_awesome_icon) {
                            $icon_class = $this->value() == $physiotherapy_lite_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($physiotherapy_lite_font_awesome_icon).'"></i>
                            <span class="physiotherapy-lite-social-class">'.esc_attr($physiotherapy_lite_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function physiotherapy_lite_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'physiotherapy-lite-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'physiotherapy_lite_customizer_script' );

if(!function_exists('physiotherapy_lite_font_awesome_icon_array')){
    function physiotherapy_lite_font_awesome_icon_array(){
