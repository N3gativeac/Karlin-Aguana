...
class Physiotherapy_Lite_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'Physiotherapy_Lite_About_Widget',
			__('VW About us', 'physiotherapy-lite'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'physiotherapy-lite' ), ) 
		);
	}
	...
	?>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','physiotherapy-lite'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','physiotherapy-lite'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','physiotherapy-lite'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','physiotherapy-lite'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','physiotherapy-lite'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Image Url:','physiotherapy-lite'); ?></label>
		<?php
			if ( $upload_image != '' ) :
...
function physiotherapy_lite_about_custom_load_widget() {
	register_widget( 'Physiotherapy_Lite_About_Widget' );
}
add_action( 'widgets_init', 'physiotherapy_lite_about_custom_load_widget' );