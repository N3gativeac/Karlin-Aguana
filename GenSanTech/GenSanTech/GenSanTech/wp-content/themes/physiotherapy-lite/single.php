          ...
          <div class="navigation">
            <?php
              ...
              the_posts_pagination( array(
                'prev_text' => __( 'Previous page', 'physiotherapy-lite' ),
                'next_text' => __( 'Next page', 'physiotherapy-lite' ),
                'before_page_number' => '<span class="meta-nav screen-reader-text">' . __( 'Page', 'physiotherapy-lite' ) . ' </span>',
              ) );
            ?>
