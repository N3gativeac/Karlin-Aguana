...
function techup_info_page() {
  ...
  <div class="wrap about-wrap one-pageily-add-css">
      ...
      <div class="feature-section three-col">
        ...
        <div class="col">
          <div class="widgets-holder-wrap">
            ...
            <p><a target="blank" href="<?php echo esc_url('https://testerwp.com/template/techup/', 'techup'); ?>" class="button button-primary">
         ...
         <div class="col">
          <div class="widgets-holder-wrap">
            <h3><?php echo __("Contact Support", "techup" ); ?></h3>
            <p><?php echo __("Getting started with a new theme can be difficult, if you have issues with Techup then throw us an email.", "techup" ); ?></p>
            <p><a target="blank" href="<?php echo esc_url('http://testerwp.com/contact/', 'techup'); ?>" class="button button-primary">
              <?php echo __("Contact Support", "techup" ); ?>
            </a></p>
          </div>
        </div>
      </div>
    ...
    <div class="one-pageily-button-container">
      <a target="blank" href="<?php echo esc_url('https://testerwp.com/logitech-premium/', 'techup'); ?>" class="button button-primary">
        <?php echo __("Read Full Description", "techup" ); ?>
      </a>
      <a target="blank" href="<?php echo esc_url('https://testerwp.com/template/logitech/', 'techup'); ?>" class="button button-primary">
