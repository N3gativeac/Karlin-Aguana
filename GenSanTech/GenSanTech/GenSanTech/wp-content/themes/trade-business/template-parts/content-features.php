...
<section id="about" class="about tradebusi">
  ...
  ?> 
      <div class="col-lg-4 col-md-6 col-sm-12 mb-3 abt-fb">
        <div class="about-box-1 tradebusi">
          <div class="about-box text-center <?php if($count == 1){echo "abouts2"; } ?>">
