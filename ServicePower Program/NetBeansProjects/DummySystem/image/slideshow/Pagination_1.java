...
public class Pagination_1 extends JComponent {

    private int index;
    private int currentIndex;
    private EventPagination_1 event;

    public void setEventPagination(EventPagination_1 event) {
        this.event = event;
    }
    ...
    private class Item extends JButton {
        ...
        public Item(int index, EventPagination_1 event) {
