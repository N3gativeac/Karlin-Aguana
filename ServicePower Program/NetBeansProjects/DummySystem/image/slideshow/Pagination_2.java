...
public class Pagination_2 extends JComponent {

    private int index;
    private int currentIndex;
    private EventPagination_2 event;

    public void setEventPagination(EventPagination_2 event) {
        this.event = event;
    }
    ...
    private class Item extends JButton {
        ...
        public Item(int index, EventPagination_2 event) {
