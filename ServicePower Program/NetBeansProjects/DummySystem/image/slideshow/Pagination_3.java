...
public class Pagination_3 extends JComponent {

    private int index;
    private int currentIndex;
    private EventPagination_3 event;

    public void setEventPagination(EventPagination_3 event) {
        this.event = event;
    }
    ...
    private class Item extends JButton {
        ...
        public Item(int index, EventPagination_3 event) {
