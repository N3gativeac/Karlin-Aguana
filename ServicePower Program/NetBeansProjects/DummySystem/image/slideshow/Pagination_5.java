...
public class Pagination_5 extends JComponent {

    private int index;
    private int currentIndex;
    private EventPagination_5 event;

    public void setEventPagination(EventPagination_5 event) {
        this.event = event;
    }
    ...
    private class Item extends JButton {
        ...
        public Item(int index, EventPagination_5 event) {
