...
public class CustomerMainActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Settings
            ...
            //feedback
            buttonFeedback = findViewById(R.id.buttonReports);
            buttonFeedback.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(CustomerMainActivity.this, feedbackNativeActivity.class);
                    startActivity(intent);
                }
            });
            //Report/Request
            buttonReport = findViewById(R.id.buttonReportRequest);
            buttonReport.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(CustomerMainActivity.this, ReportAndRequestNativeActivity.class);
                    startActivity(intent);
                }
            });
